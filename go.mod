...
>>>>>>> b775885 (Add P/D-aware SLO scheduling support)
	k8s.io/utils v0.0.0-20251002143259-bc988d571ff4
	sigs.k8s.io/controller-runtime v0.23.1
	sigs.k8s.io/gateway-api v1.4.1
	sigs.k8s.io/gateway-api-inference-extension v0.0.0-20260218160340-a774b0aa7a1a
)

replace sigs.k8s.io/gateway-api-inference-extension => github.com/RishabhSaini/gateway-api-inference-extension v0.0.0-20260223174530-3a18eeb94946
