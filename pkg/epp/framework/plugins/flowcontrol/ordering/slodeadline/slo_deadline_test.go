...
func makeSLOItem(id string, received time.Time, sloTTFTMs string) flowcontrol.QueueItemAccessor {
	...
	req.InferenceRequestV = &scheduling.InferenceRequest{Headers: map[string]string{requtil.SLOTTFTHeaderKey: sloTTFTMs}}
...
func TestCalculateSLODeadline(t *testing.T) {
	...
	reqValid.InferenceRequestV = &scheduling.InferenceRequest{Headers: map[string]string{requtil.SLOTTFTHeaderKey: "200"}}
	...
	reqInvalid.InferenceRequestV = &scheduling.InferenceRequest{Headers: map[string]string{requtil.SLOTTFTHeaderKey: "x"}}
