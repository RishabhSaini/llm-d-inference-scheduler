...
type EvictionDemand struct {
	...
	// Remaining is the time left before the tightest SLO/TTL deadline in the blocked band.
	Remaining time.Duration

	// EstimatedWait is the estimated wait time based on elapsed queue time and overload ratio.
